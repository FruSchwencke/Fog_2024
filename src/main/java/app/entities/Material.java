...
public class Material {
    ...
    public Material(String name, String description, int length, int quantity, String unitName) {
        this.name = name;
        this.description = description;
        this.length = length;
        this.quantity = quantity;
    ...
    public Material(int materialId, String name, String description, double price, int unitId, int width, int length, int height, String unitName) {
        this.materialId = materialId;
        this.name = name;
        this.description = description;
        this.price = price;
